package com.genersoft.iot.vmp.vmanager.log.aspect;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            try {
                currentUser = SecurityUtils.getUserInfo();
            } catch (Exception ex) {
                // 忽略未登录异常
            }
            ...
            if (attributes != null) {
                ...
                operLog.setOperUrl(attributes.getRequest().getRequestURI());
        ...
        else
        {
            ...
            if (attributes != null) {
                ...
                if (parameterMap != null && !parameterMap.isEmpty()) {
                    operLog.setOperParam(JSON.toJSONString(parameterMap));
                }
            }
        }
    }
