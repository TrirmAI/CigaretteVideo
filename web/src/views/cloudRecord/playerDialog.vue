...
export default {
  ...
  created() {},
  methods: {
    openDialog: function(streamInfo, timeLen, startTime, watermarkText, deviceId) {
      console.log(streamInfo)
      this.showDialog = true
      this.streamInfo = streamInfo
      this.$nextTick(() => {
          this.$refs.cloudRecordPlayer.setStreamInfo(streamInfo, timeLen, startTime, watermarkText, deviceId)
      })
    },
    stopPlay: function() {
