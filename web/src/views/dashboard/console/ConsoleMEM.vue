<template>
  <div id="ConsoleMEM" style="width: 100%; height: 100%; background: var(--container-bg); text-align: center">
    <ve-line ref="ConsoleMEM" :data="chartData" :extend="chartExtend" width="100%" height="100%" :legend-visible="false" />
  </div>
</template>
